...
Write a function named raisedToTheThird that takes in an array of numbers and 
returns a new array of each of those numbers raised to the 3rd power 
...
uses map to return a new array containing each string followed by a 
...
You may choose to complete this challenge using a for loop, for...in syntax,
 or for...of syntax.
...
forLoopTwoToThe function from challenge 4, but uses forEach instead of a for loop.
------------------------------------------------------------------------------------------------ */
...
forLoopTwoToThe function from challenge 4 and your forEachTwoToThe function 
from challenge 5, but uses map instead of a for loop or forEach.
------------------------------------------------------------------------------------------------ */

const mapTwoToThe = (arr) => {
  const newArray = arr.map(i => Math.pow(2, i));
  return newArray;
};
...
uses map to return a new array where each element is the result of the 
`charCodeAt` method on the original array element.
...
Write a function that, given an array of numbers as input, uses 
map to return a new array where each element is either the string 
"even" or the string "odd", based on each value.

If any element in the array is not a number, the resulting array 
should have the string "N/A" in its place.
...
Write a function named extractAbilities that, given the 
array of abilities, uses map to create an array containing 
...
const extractAbilities = (arr) => {
  const abilityArray = [];
  arr.map(i => abilityArray.push(i.ability.name));
  return abilityArray;
};
...
Write a function named extractStats that, given an array of 
stats, uses map to return an array of objects containing the 
stat name and the total.
...
const extractStats = (arr) => {
  ...
  const newArray = arr.map(i => {
    let object = {};
    object.name = i.stat.name;
    object.total = i.baseStat + i.effort;
    return object;
  });
